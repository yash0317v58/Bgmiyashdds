...
TOKEN = '6972410361:AAGO3MKhkWIzgoUhHqNbJWadCP0aae1WquQ'
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        if user_data:
            ...
            response = "*No account information found. Please contact the administrator @mantel_dc.*"
        bot.reply_to(message, response, parse_mode='Markdown')
    elif message.text == "Help❓":
        bot.reply_to(message, "*Help selected @MANTAL_BGMI*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Contact admin selected @mantel_dc*", parse_mode='Markdown')
    else:
